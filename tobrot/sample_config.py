...
class Config(object):
    ...
    LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@LeechingsRobot")
    YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@LeechingsRobot")
    DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "downloads@LeechingsRobot")
    CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@LeechingsRobot")
    GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize@LeechingsRobot")
    ...
    UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "leechasdoc@LeechingsRobot")
